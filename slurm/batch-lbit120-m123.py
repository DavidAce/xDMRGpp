...
config_paths = {
    ...
    'output_stem'       : 'mbl',
    'config_dir'        : "config-lbit120",
    'output_dir'        : "output-lbit120",
    'status_dir'        : "status-lbit120",
...
config_ranges = {
    ...
    "model::lbit::u_lambda": ['0.0','1.0', '2.0', '4.0', '6.0', '8.0'],
...
batch_setup = get_batch_setup('lbit120-m123')
