...
config_paths = {
    ...
    'output_stem'       : 'mbl',
    'config_dir'        : "config-L16-xi",
    'output_dir'        : "output-xi",
    'status_dir'        : "status-xi",
...
config_ranges = {
    ...
    "flbit::time_final_real": ['1e8'], #"{:.1e}".format(max_time),
...
batch_setup = get_batch_setup('lbit115-xi')
