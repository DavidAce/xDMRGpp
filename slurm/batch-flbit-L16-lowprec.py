...
config_paths = {
    ...
    'output_stem'       : 'mbl',
    'config_dir'        : "config-lowprec",
    'output_dir'        : "output-lowprec",
    'status_dir'        : "status-lowprec",
...
config_ranges = {
    ...
    "flbit::time_start_real": ['0.001'],
    "flbit::time_start_imag": ['0.0'],
    "flbit::time_final_real": ['10'], #"{:.1e}".format(max_time),
...
batch_setup = get_batch_setup('lbit111-lowprec')
