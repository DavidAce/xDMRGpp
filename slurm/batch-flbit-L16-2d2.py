...
config_paths = {
    ...
    'output_stem'       : 'mbl',
    'config_dir'        : "config-L16-2d2",
    'output_dir'        : "output",
    'status_dir'        : "status-2d2",
...
config_ranges = {
    ...
    "state::init::initial_axis": ["+z"],
    "state::init::initial_state": ["PRODUCT_STATE_TWO_DOWN"],
    "model::model_size": ['16'],
    "input::bitfield": ['2'],
...
batch_setup = get_batch_setup('lbit105-2d2')
