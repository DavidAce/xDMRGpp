...
config_paths = {
    ...
    'output_stem'       : 'mbl',
    'config_dir'        : "config-L16-now8",
    'output_dir'        : "output-now8",
    'status_dir'        : "status-now8",
...
batch_setup = get_batch_setup('lbit114-now8')
