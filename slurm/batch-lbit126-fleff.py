...
config_paths = {
    ...
    'output_stem'       : 'mbl',
    'config_dir'        : "config-lbit126",
    'output_dir'        : "output-lbit126",
    'status_dir'        : "status-lbit126",
...
config_ranges = {
    ...
    "model::lbit::u_lambda": ['1.0', '5.0'],
    "model::lbit::u_wkind": ['EXPDECAY'],
    "model::lbit::u_mkind": ['MATRIX_V3'],
...
batch_setup = get_batch_setup('lbit126-fleff')
