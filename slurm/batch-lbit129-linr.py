...
config_paths = {
    ...
    'output_stem'       : 'mbl',
    'config_dir'        : "config-lbit129",
    'output_dir'        : "output-lbit129",
    'status_dir'        : "status-lbit129",
...
config_ranges = {
    ...
    "model::lbit::J2_span": ['0','1','2','3','4','5','6','7','8'],
...
batch_setup = get_batch_setup('lbit129-linr')
