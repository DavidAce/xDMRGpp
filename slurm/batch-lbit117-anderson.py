...
config_paths = {
    ...
    'output_stem'       : 'mbl',
    'config_dir'        : "config-lbit117",
    'output_dir'        : "output-lbit117",
    'status_dir'        : "status-lbit117",
...
config_ranges = {
    ...
    "model::lbit::u_g8w8": ['EXPDECAY'],
    "model::lbit::u_type": ['ANDERSON'],
...
batch_setup = get_batch_setup('lbit117-anderson')
