...
config_paths = {
    ...
    'output_stem'       : 'mbl',
    'config_dir'        : "config-L12-lind",
    'output_dir'        : "output-lind",
    'status_dir'        : "status-lind",
...
config_ranges = {
    ...
    "state::init::initial_state": ["PRODUCT_STATE_NEEL_DISLOCATED"],
    "model::model_size": ['12'],
...
batch_setup = get_batch_setup('lbit107-lind')
