...
config_paths = {
    ...
    'output_stem'       : 'mbl',
    'config_dir'        : "config-lbit122",
    'output_dir'        : "output-lbit122",
    'status_dir'        : "status-lbit122",
...
config_ranges = {
    ...
    "model::lbit::u_lambda": ['0.0', '0.1', '1.0'],
...
batch_setup = get_batch_setup('lbit122-fleff')
