...
config_ranges = {
    ...
    "model::ising_majorana::delta": ['-8.00', '-7.50', '-7.00', '-6.50', '-6.00', '-5.50', '-5.00', '-4.50', '-4.00', '-3.50', '-3.00', '-2.00', '-1.00',
                                     '+0.00',
                                     '+1.00', '+2.00',  '+3.00', '+3.50', '+4.00', '+4.50', '+5.00', '+5.50', '+6.00', '+6.50', '+7.00', '+7.50', '+8.00'],
