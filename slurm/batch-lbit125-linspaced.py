...
config_paths = {
    ...
    'output_stem'       : 'mbl',
    'config_dir'        : "config-lbit125",
    'output_dir'        : "output-lbit125",
    'status_dir'        : "status-lbit125",
...
config_ranges = {
    ...
    "console::loglevel": ['2'],
    "solvers::svd::truncation_min": ['1e-5'],
    "solvers::svd::truncation_max": ['1e-5'],
    ...
    "flbit::bond_max": ['8192'],
    "flbit::time_start_real": ['1e13'],
    "flbit::time_start_imag": ['0.0'],
    "flbit::time_final_real": ['1.0000000000025e13'],  # "{:.1e}".format(max_time),
    "flbit::time_final_imag": ['0.0'],
    "flbit::time_num_steps": ['41'],
...
batch_setup = get_batch_setup('lbit125-linspaced')
