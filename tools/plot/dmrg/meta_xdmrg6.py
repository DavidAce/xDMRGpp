    ...
    meta = {
        ...
        'infomasscenter-d': {
            ...
            'include': {
                ...
                'd': [-8.00, -7.50, -7.00, -6.50, -6.00, -5.50, -5.00, -4.50, -4.00, -3.50, -3.00, -2.50, -2.00, -1.50, -1.00, -0.50, 0.00, 0.50, 1.00, 1.50, 2.00, 2.50, 3.00, 3.50, 4.00, 4.50, 5.00, 5.50, 6.00, 6.50, 7.00, 7.50, 8.00],
                # 'd': [-1.0],
        ...
        'infomasscenter-gLd': {
            ...
            # 'dsetname': 'information_per_scale',
            'groupbase': 'tables',
            'groupname': 'information_center_of_mass',
            'colname': 'scale',
            'figspec': ['ø'],
            'subspec': ['g'],
            'linspec': ['L'],
            'xaxspec': ['d'],
            'single-realizations': False,
            'fillerror': True,
            'plotdir': Path(plotdir, Path(mplstyle).stem),
            'filename': 'info-natural-center_vs_d_foreach_g',
            'palettes': ["viridis_r", "autumn_r", "summer_r"],
        ...
        'infomasscenterdist-dLg': {
            ...
            'xmax' : 5,
            'plotdir': Path(plotdir, Path(mplstyle).stem),
            'filename': 'info-center-dist_vs_g_foreach_L',
            'palettes': ["viridis_r", "autumn_r", "summer_r"],
            'mplstyle': mplstyle,
            'ylabel': '$p(m_c \log 2)$',
            'xlabel': "$m_c \log 2$",
        ...
        'infotopobit-d': {
            ...
            'fillerror': True,
            'plotdir': Path(plotdir, Path(mplstyle).stem),
            'filename': 'infodecay_vs_d_foreach_g',
            'palettes': ["viridis_r", "autumn_r", "summer_r"],
            'mplstyle': mplstyle,
        ...
        'infoperscale-Lgd': {
            ...
            # 'ynormalize': True,
            'yscale': 'log',
            'legendcols': ['g:.2f', 'd:.2f'],  # Choose 'num', 'bmax','tsim'
            'legendoutside': False,
            'legendcollect': False,
        ...
        'opdm-gapsize-d-L': {
            ...
            'include': {
                'L': [12, 14, 16, 18],
                'g': [0.500],
                'd': [-8.00, -7.50, -7.00, -6.50, -6.00, -5.50, -5.00, -4.50, -4.00, -3.50, -3.00, -2.50, -2.00, -1.50,
                      -1.00, -0.50, 0.00, 0.50, 1.00, 1.50, 2.00, 2.50, 3.00, 3.50, 4.00, 4.50, 5.00, 5.50, 6.00, 6.50,
                      7.00, 7.50, 8.00],
                'ø': [None], # Dummy variable for subspec
            },
            'groupbase': 'tables',
