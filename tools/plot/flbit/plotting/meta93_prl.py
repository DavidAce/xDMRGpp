...
def get_meta(plotdir, cachedir):
    ...
    default_square2 = {
        ...
        'constrained_layout': False,
        'axtitle': False,
        'figsize': (3.404 * 0.4935, 3.404*0.602),
        'subplots': {
            'top': 0.80,
            'bottom': 0,
            'left': 0.30,
    ...
    meta = {
        ...
        'lbit-avg': {
            ...
            'plotdir': Path(plotdir, Path(mplstyle).stem),
            'filename': 'lbit-L-f0.2-halfheight-halfwidth-flip',
            'mplstyle': mplstyle,
            # 'ymin': -16,
            'ymin': 1e-20,
            'ymax': 2,
        ...
        'posx': {
            ...
            'colname': 'number_entropy',
            'normpage': False,
            # 'titlename': '$\Delta \overline{\langle x_n \\rangle}$',
            # 'filter': {
            # 'f': [0.3,0.5],
            # 'u': [16],
            # },
        ...
        'posx_neel0': {
            ...
            # 'u': [16],
            # },
            'ylabel': '$\overline{\langle x_n \\rangle}$',
            'xlabel': '$\ln\ln t$',
            # 'yformat': '%.3f',
            # 'yscale': 'log',
            'plotprefix': 'PosX',
        ...
        'divg-varx': {  # Distribution of infinite time averaged entropy
            ...
            # 'figsize': (3.375, 3.00),
            'ylabel': '$p({\sigma^2_{x_n\hspace{-1ex}}}^\infty)$',
            'yscale': 'log',
            # 'yformat': '%.2f',
            'ymaloc': LogLocator(numticks=9),  # FixedLocator([1e-3,1e-2,1e-1,1e0,1e1]),
            # 'ymafmt': LogFormatterMathtext(labelOnlyBase=True),
            ...
            'bins': 100,
            'range': (0, 1.2),
            'xlabel': '${\sigma^2_{x_n\hspace{-0.4ex}}}^\infty$',
            'density': True,
            'marklog2': False,
            'marklog3': False,
            'plotVarX': True,
        ...
        'tavg-varx-inset': {
            ...
            'plotdir': Path(plotdir, Path(mplstyle).stem),
            'filename':'VarX-lnlnt-f0.2-inset',
            'plotluitz': False,
            'ymin': 0.156,
            'ymax': 0.167,
            'xmin': 11,
        ...
        'lbit113-w_on': {
            ...
            'ylabel': '$|\overline O(L/2,j)|$',
            # 'ylabel': '$\log_{10} \\bar O(|i-j|)$ ',
            'xlabel': "$j$",
            # 'xticks': [0, 0.25, 0.5, 0.75, 1.0] if prb else None,
            'xticks': [0, 7, 14, 21, 28] if prl else None,
            ...
            'plotprefix': 'lbit-arithmetic',
            'plotdir': Path(plotdir, Path(mplstyle).stem),
            'filename': 'lbit-L28-arithmetic-weights-on-flip-notitle',
            'mplstyle': mplstyle,
            # 'ymin': -16,
            'ymin': 1e-16,
            'xmax': 30,
            ...
            'legendoutside': False,
            'legendcollect': False,
            'legendlocation': (0.00, 1.025) if prl else 'center left',
            # 'legendtitle': 'Arithmetic average',
            # 'legendtitle': '$y = C e^{-|i-j|/\\xi_\\tau}$',
            # 'legendtitle': '$\log \\bar O(x) = a - x \\xi_\\tau^{-1}$',
            'lbit-site': ['mid'],
        ...
        'lbit113-w_off': {
            ...
            'plotprefix': 'lbit-arithmetic',
            'plotdir': Path(plotdir, Path(mplstyle).stem),
            'filename': 'lbit-L28-arithmetic-weights-off-flip-notitle',
            'mplstyle': mplstyle,
            # 'ymin': -16,
            'ymin': 1e-16,
            'xmax': 30,
