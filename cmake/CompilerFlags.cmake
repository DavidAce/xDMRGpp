...
if(DMRG_USE_FLOAT128 OR DMRG_USE_QUADMATH)
    set(DMRG_HIGHPREC_REAL fp128)
    set(DMRG_HIGHPREC_CPLX cx128)
else()
    set(DMRG_HIGHPREC_REAL fp80)
    set(DMRG_HIGHPREC_CPLX cx80)
endif()
message(STATUS "Highest available precision scalar types: ${DMRG_HIGHPREC_REAL}, ${DMRG_HIGHPREC_CPLX}")
...
# Settings for ccache
if(DMRG_CCACHE_ACTIVE AND CMAKE_CXX_COMPILER_ID MATCHES "Clang")
