...
function(pkg_is_valid_package_dir_var out_var var)
    ...
    file(GLOB _config_files LIST_DIRECTORIES FALSE
         "${_value}/*Config.cmake"
         "${_value}/*-config.cmake")
    if(_config_files)
...
function(pkg_get_lock_file out_var)
    ...
    elseif(DEFINED ENV{USERPROFILE})
        set(_lock_root "$ENV{USERPROFILE}/.cache/cmake-pkginstall")
    else()
        set(_lock_root "${CMAKE_BINARY_DIR}/CMakeFiles")
    endif()
    file(MAKE_DIRECTORY "${_lock_root}")
    string(SHA256 _source_hash "${CMAKE_SOURCE_DIR}")
    set(${out_var} "${_lock_root}/${PROJECT_NAME}-${_source_hash}.lock" PARENT_SCOPE)
endfunction()
...
function(pkg_compute_fingerprint out_var pkg_name pkg_version install_dir pkg_cmake_args)
    ...
    string(JOIN "\n" _fingerprint_input
            ...
            "pkg_cmake_args=${_pkg_args_string}")
...
function(pkg_manifest_matches out_var manifest_file expected_fingerprint)
    ...
    include("${manifest_file}" OPTIONAL RESULT_VARIABLE _manifest_loaded)
...
function(pkg_write_manifest manifest_file pkg_name pkg_version install_dir fingerprint pkg_cmake_args)
    ...
    pkg_manifest_append_set("${manifest_file}" PKG_MANIFEST_CMAKE_ARGS "${_pkg_args_string}")
...
function(generate_init_cache)
    ...
    foreach(var ${live_vars})
        ...
        pkg_is_valid_package_dir_var(_dir_var_is_valid "${var}")
