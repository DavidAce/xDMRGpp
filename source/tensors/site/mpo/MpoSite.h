...
class MpoSite {
    ...
    virtual Eigen::Tensor<cx128, 4> get_mpo_q(cx64 energy_shift_per_site, std::optional<std::vector<size_t>> nbody = std::nullopt,
    ...
    [[nodiscard]] Eigen::Tensor<cx64, 4>         MPO_energy_shifted_view(cx64 energy_shift_per_site) const;
    [[nodiscard]] Eigen::Tensor<cx128, 4>        MPO_energy_shifted_view_q(cx64 energy_shift_per_site) const;
    ...
    [[nodiscard]] Eigen::Tensor<cx64, 4>        MPO2_nbody_view(std::optional<std::vector<size_t>> nbody,
                                                                std::optional<std::vector<size_t>> skip = std::nullopt) const;
    /* clang-format off */
    template<typename Scalar> [[nodiscard]] Eigen::Tensor<Scalar, 4>  MPO_as() const;
    template<typename Scalar> [[nodiscard]] Eigen::Tensor<Scalar, 4>  MPO_energy_shifted_view_as(cx64 energy_shift_per_site) const;
    template<typename Scalar> [[nodiscard]] Eigen::Tensor<Scalar, 4>  MPO_nbody_view_as(std::optional<std::vector<size_t>> nbody,
                                                                                        std::optional<std::vector<size_t>> skip = std::nullopt) const;

    template<typename Scalar> [[nodiscard]] Eigen::Tensor<Scalar, 4>  MPO2_as() const;
    template<typename Scalar> [[nodiscard]] Eigen::Tensor<Scalar, 4>  MPO2_nbody_view_as(std::optional<std::vector<size_t>> nbody,
                                                                                         std::optional<std::vector<size_t>> skip = std::nullopt) const;
    /* clang-format on */
