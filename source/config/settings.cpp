...
void settings::load(Loader &dmrg_config) {
    ...
    dmrg_config.load_parameter("strategy::dmrg_bond_expansion_policy"               , strategy::dmrg_bond_expansion_policy);
    dmrg_config.load_parameter("strategy::dmrg_bond_expansion::dmrg3s::maxalpha"    , strategy::dmrg_bond_expansion::dmrg3s::maxalpha);
    dmrg_config.load_parameter("strategy::dmrg_bond_expansion::dmrg3s::minalpha"    , strategy::dmrg_bond_expansion::dmrg3s::minalpha);
    dmrg_config.load_parameter("strategy::dmrg_bond_expansion::preopt::bond_factor" , strategy::dmrg_bond_expansion::preopt::bond_factor);
    dmrg_config.load_parameter("strategy::dmrg_bond_expansion::preopt::maxiter"     , strategy::dmrg_bond_expansion::preopt::maxiter);
    dmrg_config.load_parameter("strategy::dmrg_bond_expansion::preopt::nkrylov"     , strategy::dmrg_bond_expansion::preopt::nkrylov);
    ...
    dmrg_config.load_parameter("precision::eigs_ncv_max"                          , precision::eigs_ncv_max);
    dmrg_config.load_parameter("precision::eigs_blk_min"                          , precision::eigs_blk_min);
    dmrg_config.load_parameter("precision::eigs_blk_max"                          , precision::eigs_blk_max);
