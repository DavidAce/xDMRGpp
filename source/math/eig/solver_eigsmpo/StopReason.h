...
enum class StopReason : int {
    ...
    converged_rNorms      = 1,   /*! The residual norm fell below the convergence threshold. */
    saturated_rNorms      = 2,   /*! The residual norm stopped decreasing */
    ...
    saturated_eigVals     = 16,  /*! The eigenvalues stopped improving.  */
