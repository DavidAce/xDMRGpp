...
int eig::solver::qsygvd_eigen(fp128 *matrixA, fp128 *matrixB, size_type L) {
    eig::log->trace("Starting eig qsygvd_eigen");
    using Scalar = fp128;
    ...
    if(solver.info() == Eigen::ComputationInfo::Success) {
        ...
        throw std::runtime_error("Eigen qsygvd_eigen failed with error: " + std::to_string(solver.info()));
    }
