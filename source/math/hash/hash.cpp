...
namespace hash {
    ...
    template std::size_t hash_buffer(const fp32 *v, unsigned long size, std::size_t seed);
    template std::size_t hash_buffer(const fp64 *v, unsigned long size, std::size_t seed);
    template std::size_t hash_buffer(const fp128 *v, unsigned long size, std::size_t seed);
    template std::size_t hash_buffer(const cx32 *v, unsigned long size, std::size_t seed);
    template std::size_t hash_buffer(const cx64 *v, unsigned long size, std::size_t seed);
    template std::size_t hash_buffer(const cx128 *v, unsigned long size, std::size_t seed);
}
