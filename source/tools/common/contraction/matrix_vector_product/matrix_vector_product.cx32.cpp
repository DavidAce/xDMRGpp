...
template void tools::common::contraction::matrix_vector_product(Scalar *res_ptr, const Scalar *const mps_ptr, std::array<long, 3> mps_dims, //
...
template void tools::common::contraction::matrix_vector_product(Eigen::Tensor<Scalar, 3>                    &res,  //
                                                                const Eigen::Tensor<Scalar, 3>              &mps,  //
                                                                const std::vector<Eigen::Tensor<Scalar, 4>> &mpo,  //
                                                                const x2::Tensor<Scalar, 3>                 &envL, //
                                                                const x2::Tensor<Scalar, 3>                 &envR);
template void tools::common::contraction::matrix_vector_product(Eigen::Tensor<Scalar, 3>       &res,  //
                                                                const Eigen::Tensor<Scalar, 3> &mps,  //
