...
template void tools::common::contraction::contract_mps_mpo_env(      fp128 *       res_ptr , std::array<long,2> res_dims,
...
template void tools::common::contraction::contract_mps_mpo_env(      cx128 *       res_ptr , std::array<long,2> res_dims,
...
template void tools::common::contraction::contract_mps_mpo_env(      fp128 *       res_ptr , std::array<long,3> res_dims,
...
template void tools::common::contraction::contract_mps_mpo_env(      cx128 *       res_ptr , std::array<long,3> res_dims,
