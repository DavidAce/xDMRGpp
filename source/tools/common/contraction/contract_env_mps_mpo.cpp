...
template void tools::common::contraction::contract_env_mps_mpo(      fp32 *       res_ptr , std::array<long,3> res_dims,
                                                               const fp32 * const env_ptr , std::array<long,3> env_dims,
                                                               const fp32 * const mps_ptr , std::array<long,3> mps_dims,
                                                               const fp32 * const mpo_ptr , std::array<long,4> mpo_dims);
template void tools::common::contraction::contract_env_mps_mpo(      fp64 *       res_ptr , std::array<long,3> res_dims,
