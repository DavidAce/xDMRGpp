#include "vector_matrix_product.impl.h"

using Scalar = cx32;

using namespace tools::common::contraction;
template void tools::common::contraction::vector_matrix_product(Scalar *res_ptr, const Scalar *const mps_ptr, std::array<long, 3> mps_dims, //
