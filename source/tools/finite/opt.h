...
namespace tools::finite::opt {
    ...
    template<typename Scalar> opt_mps<Scalar> get_updated_state(const TensorsFinite<Scalar> &tensors, const opt_mps<Scalar> &initial_state, OptMeta &meta);
    template<typename Scalar> opt_mps<Scalar> find_ground_state(const TensorsFinite<Scalar> &tensors, const opt_mps<Scalar> &initial_state, OptMeta &meta);
}
