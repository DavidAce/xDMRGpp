...
template Eigen::Tensor<fp32, 1>  tools::finite::mps::mps2tensor<fp32>(const std::vector<std::unique_ptr<MpsSite<fp32>>> &mps_sites, std::string_view name);
template Eigen::Tensor<fp64, 1>  tools::finite::mps::mps2tensor<fp64>(const std::vector<std::unique_ptr<MpsSite<fp64>>> &mps_sites, std::string_view name);
template Eigen::Tensor<fp128, 1> tools::finite::mps::mps2tensor<fp128>(const std::vector<std::unique_ptr<MpsSite<fp128>>> &mps_sites, std::string_view name);
template Eigen::Tensor<cx32, 1>  tools::finite::mps::mps2tensor<fp32>(const std::vector<std::unique_ptr<MpsSite<cx32>>> &mps_sites, std::string_view name);
template Eigen::Tensor<cx64, 1>  tools::finite::mps::mps2tensor<fp64>(const std::vector<std::unique_ptr<MpsSite<cx64>>> &mps_sites, std::string_view name);
template Eigen::Tensor<cx128, 1> tools::finite::mps::mps2tensor<fp128>(const std::vector<std::unique_ptr<MpsSite<cx128>>> &mps_sites, std::string_view name);
template Eigen::Tensor<cx32, 1>  tools::finite::mps::mps2tensor<cx32>(const std::vector<std::unique_ptr<MpsSite<cx32>>> &mps_sites, std::string_view name);
template Eigen::Tensor<cx64, 1>  tools::finite::mps::mps2tensor<cx64>(const std::vector<std::unique_ptr<MpsSite<cx64>>> &mps_sites, std::string_view name);
template Eigen::Tensor<cx128, 1> tools::finite::mps::mps2tensor<cx128>(const std::vector<std::unique_ptr<MpsSite<cx128>>> &mps_sites, std::string_view name);
...
template Eigen::Tensor<fp32, 1>  tools::finite::mps::mps2tensor<fp32>(const StateFinite<fp32> &state);
template Eigen::Tensor<fp64, 1>  tools::finite::mps::mps2tensor<fp64>(const StateFinite<fp64> &state);
template Eigen::Tensor<fp128, 1> tools::finite::mps::mps2tensor<fp128>(const StateFinite<fp128> &state);
template Eigen::Tensor<cx32, 1>  tools::finite::mps::mps2tensor<fp32>(const StateFinite<cx32> &state);
template Eigen::Tensor<cx64, 1>  tools::finite::mps::mps2tensor<fp64>(const StateFinite<cx64> &state);
template Eigen::Tensor<cx128, 1> tools::finite::mps::mps2tensor<fp128>(const StateFinite<cx128> &state);
template Eigen::Tensor<cx32, 1>  tools::finite::mps::mps2tensor<cx32>(const StateFinite<cx32> &state);
template Eigen::Tensor<cx64, 1>  tools::finite::mps::mps2tensor<cx64>(const StateFinite<cx64> &state);
template Eigen::Tensor<cx128, 1> tools::finite::mps::mps2tensor<cx128>(const StateFinite<cx128> &state);
...
/* clang-format off */
template size_t tools::finite::mps::merge_multisite_mps(StateFinite<fp32> &state, const Eigen::Tensor<fp32, 3> &multisite_mps, const std::vector<size_t> &sites, long center_position, MergeEvent mevent, std::optional<svd::config> svd_cfg, std::optional<LogPolicy> logPolicy);
template size_t tools::finite::mps::merge_multisite_mps(StateFinite<fp64> &state, const Eigen::Tensor<fp64, 3> &multisite_mps, const std::vector<size_t> &sites, long center_position, MergeEvent mevent, std::optional<svd::config> svd_cfg, std::optional<LogPolicy> logPolicy);
template size_t tools::finite::mps::merge_multisite_mps(StateFinite<fp128> &state, const Eigen::Tensor<fp128, 3> &multisite_mps, const std::vector<size_t> &sites, long center_position, MergeEvent mevent, std::optional<svd::config> svd_cfg, std::optional<LogPolicy> logPolicy);
template size_t tools::finite::mps::merge_multisite_mps(StateFinite<cx32> &state, const Eigen::Tensor<cx32, 3> &multisite_mps, const std::vector<size_t> &sites, long center_position, MergeEvent mevent, std::optional<svd::config> svd_cfg, std::optional<LogPolicy> logPolicy);
template size_t tools::finite::mps::merge_multisite_mps(StateFinite<cx64> &state, const Eigen::Tensor<cx64, 3> &multisite_mps, const std::vector<size_t> &sites, long center_position, MergeEvent mevent, std::optional<svd::config> svd_cfg, std::optional<LogPolicy> logPolicy);
template size_t tools::finite::mps::merge_multisite_mps(StateFinite<cx128> &state, const Eigen::Tensor<cx128, 3> &multisite_mps, const std::vector<size_t> &sites, long center_position, MergeEvent mevent, std::optional<svd::config> svd_cfg, std::optional<LogPolicy> logPolicy);
/* clang-format on */
