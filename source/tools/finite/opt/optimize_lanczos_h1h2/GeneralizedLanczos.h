...
struct GeneralizedLanczos {
    ...
    GeneralizedLanczos(Eigen::Index nev, Eigen::Index ncv, OptAlgo algo, OptRitz ritz, const MatrixType &V, const auto &mpos, const auto &enve, const auto &envv)
        : nev(nev),       //
          ncv(ncv),       //
          algo(algo),     //
          ritz(ritz),     //
