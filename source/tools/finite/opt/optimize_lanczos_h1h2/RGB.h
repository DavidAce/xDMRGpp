...
class RGB : public SolverBase<Scalar> {
    public:
    ...
    private:
    void write_Q3b_RGB(Eigen::Index i);
    ...
    MatrixType G;
    MatrixType Q_enr_i; // Enrichment created on iteration i
    ...
    void set_maxBasisBlocks(Eigen::Index bs);
};
