...
template class tools::finite::opt::opt_mps<fp32>;
template class tools::finite::opt::opt_mps<fp64>;
template class tools::finite::opt::opt_mps<fp128>;
template class tools::finite::opt::opt_mps<cx32>;
template class tools::finite::opt::opt_mps<cx64>;
template class tools::finite::opt::opt_mps<cx128>;
