...
namespace tools::finite::h5 {
    ...
    void tools::finite::h5::save::measurements(h5pp::File &h5file, const StorageInfo &sinfo, const TensorsFinite<Scalar> &tensors,
                                               const AlgorithmStatus &status) {
        save::measurements(h5file, sinfo, tensors.get_state(), tensors.get_model(), tensors.get_edges(), status);
    }
    template void tools::finite::h5::save::measurements(h5pp::File &, const StorageInfo &, const TensorsFinite<cx64> &, const AlgorithmStatus &);
    template void tools::finite::h5::save::measurements(h5pp::File &, const StorageInfo &, const TensorsFinite<cx128> &, const AlgorithmStatus &);

    template<typename Scalar>
    void save::measurements(h5pp::File &h5file, const StorageInfo &sinfo, const StateFinite<Scalar> &state, const ModelFinite<Scalar> &model,
        ...
        if(not attrs.link_exists) h5file.createTable(h5pp_table_measurements_finite<Scalar>::get_h5t(), table_path, "measurements");
        ...
        typename h5pp_table_measurements_finite<Scalar>::table measurement_entry{};
    ...
    template void tools::finite::h5::save::measurements(h5pp::File &, const StorageInfo &, const StateFinite<cx64> &, const ModelFinite<cx64> &,
                                                        const EdgesFinite<cx64> &, const AlgorithmStatus &);
    template void tools::finite::h5::save::measurements(h5pp::File &, const StorageInfo &, const StateFinite<cx128> &, const ModelFinite<cx128> &,
                                                        const EdgesFinite<cx128> &, const AlgorithmStatus &);

    template<typename Scalar>
    void save::correlations(h5pp::File &h5file, const StorageInfo &sinfo, const StateFinite<Scalar> &state) {
    ...
    template void tools::finite::h5::save::correlations(h5pp::File &, const StorageInfo &, const StateFinite<cx64> &);
    template void tools::finite::h5::save::correlations(h5pp::File &, const StorageInfo &, const StateFinite<cx128> &);

    template<typename Scalar>
    void save::expectations(h5pp::File &h5file, const StorageInfo &sinfo, const StateFinite<Scalar> &state) {
    ...
    template void tools::finite::h5::save::expectations(h5pp::File &, const StorageInfo &, const StateFinite<cx64> &);
    template void tools::finite::h5::save::expectations(h5pp::File &, const StorageInfo &, const StateFinite<cx128> &);

    template<typename Scalar>
    void save::opdm(h5pp::File &h5file, const StorageInfo &sinfo, const StateFinite<Scalar> &state) {
        ...
        if(not attrs.link_exists) {
            ...
            using opdm_type           = typename std::remove_cvref_t<decltype(opdm)>::Scalar;
    ...
    template void tools::finite::h5::save::opdm(h5pp::File &, const StorageInfo &, const StateFinite<cx64> &);
    template void tools::finite::h5::save::opdm(h5pp::File &, const StorageInfo &, const StateFinite<cx128> &);

    template<typename Scalar>
    void save::opdm_spectrum(h5pp::File &h5file, const StorageInfo &sinfo, const StateFinite<Scalar> &state) {
    ...
    template void tools::finite::h5::save::opdm_spectrum(h5pp::File &, const StorageInfo &, const StateFinite<cx64> &);
    template void tools::finite::h5::save::opdm_spectrum(h5pp::File &, const StorageInfo &, const StateFinite<cx128> &);
    ...
    template<typename Scalar>
    void save::bond_dimensions(h5pp::File &h5file, const StorageInfo &sinfo, const StateFinite<Scalar> &state) {
    ...
    template void tools::finite::h5::save::bond_dimensions(h5pp::File &, const StorageInfo &, const StateFinite<cx64> &);
    template void tools::finite::h5::save::bond_dimensions(h5pp::File &, const StorageInfo &, const StateFinite<cx128> &);

    template<typename Scalar>
    void save::truncation_errors(h5pp::File &h5file, const StorageInfo &sinfo, const StateFinite<Scalar> &state) {
    ...
    template void tools::finite::h5::save::truncation_errors(h5pp::File &, const StorageInfo &, const StateFinite<cx64> &);
    template void tools::finite::h5::save::truncation_errors(h5pp::File &, const StorageInfo &, const StateFinite<cx128> &);

    template<typename Scalar>
    void save::entanglement_entropies(h5pp::File &h5file, const StorageInfo &sinfo, const StateFinite<Scalar> &state) {
    ...
    template void tools::finite::h5::save::entanglement_entropies(h5pp::File &, const StorageInfo &, const StateFinite<cx64> &);
    template void tools::finite::h5::save::entanglement_entropies(h5pp::File &, const StorageInfo &, const StateFinite<cx128> &);

    template<typename Scalar>
    void save::subsystem_entanglement_entropies(h5pp::File &h5file, const StorageInfo &sinfo, const StateFinite<Scalar> &state) {
    ...
    template void tools::finite::h5::save::subsystem_entanglement_entropies(h5pp::File &, const StorageInfo &, const StateFinite<cx64> &);
    template void tools::finite::h5::save::subsystem_entanglement_entropies(h5pp::File &, const StorageInfo &, const StateFinite<cx128> &);

    template<typename Scalar>
    void save::information_lattice(h5pp::File &h5file, const StorageInfo &sinfo, const StateFinite<Scalar> &state) {
    ...
    template<typename Scalar>
    void save::information_per_scale(h5pp::File &h5file, const StorageInfo &sinfo, const StateFinite<Scalar> &state) {
    ...
    template<typename Scalar>
    void save::information_center_of_mass(h5pp::File &h5file, const StorageInfo &sinfo, const StateFinite<Scalar> &state) {
    ...
    template<typename Scalar>
    void save::number_probabilities(h5pp::File &h5file, const StorageInfo &sinfo, const StateFinite<Scalar> &state) {
    ...
    template<typename Scalar>
    void save::renyi_entropies(h5pp::File &h5file, const StorageInfo &sinfo, const StateFinite<Scalar> &state) {
    ...
    template<typename Scalar>
    void save::number_entropies(h5pp::File &h5file, const StorageInfo &sinfo, const StateFinite<Scalar> &state) {
    ...
    template void save::number_entropies(h5pp::File &h5file, const StorageInfo &sinfo, const StateFinite<cx64> &state);
    template void save::number_entropies(h5pp::File &h5file, const StorageInfo &sinfo, const StateFinite<cx128> &state);

    template<typename Scalar>
    void save::bonds(h5pp::File &h5file, const StorageInfo &sinfo, const StateFinite<Scalar> &state) {
        ...
        auto        h5real      = h5pp::type::getH5Type<RealScalar<Scalar>>();
        auto        bonds_real  = std::vector<h5pp::varr_t<RealScalar<Scalar>>>();
        std::string column_name = "L_";
        std::string table_title = "Bonds (singular values)";
        bonds_real.reserve(state.template get_length<size_t>() + 1);
        for(const auto &mps : state.mps_sites) {
            bonds_real.emplace_back(Eigen::Tensor<RealScalar<Scalar>, 1>(mps->get_L().real()));
            if(mps->isCenter()) { bonds_real.emplace_back(Eigen::Tensor<RealScalar<Scalar>, 1>(mps->get_LC().real())); }
        }
        data_as_table_vla(h5file, sinfo, bonds_real, h5real, "bonds", table_title, column_name);
    }

    template void save::bonds(h5pp::File &h5file, const StorageInfo &sinfo, const StateFinite<cx64> &state);
    template void save::bonds(h5pp::File &h5file, const StorageInfo &sinfo, const StateFinite<cx128> &state);

    template<typename Scalar>
    void save::state(h5pp::File &h5file, const StorageInfo &sinfo, const StateFinite<Scalar> &state) {
        ...
        for(const auto &mps : state.mps_sites) {
            auto dsetName = fmt::format("{}/M_{}", mps_prefix, mps->template get_position<long>());
            ...
            if(mpsIsReal) {
                h5file.writeDataset(Eigen::Tensor<RealScalar<Scalar>, 3>(mps->get_M_bare().real()), dsetName,
                                    H5D_CHUNKED); // Important to write bare matrices!!
            } else {
            ...
            h5file.writeAttribute(Eigen::Tensor<RealScalar<Scalar>, 1>(mps->get_L().real()), dsetName, "L");
            h5file.writeAttribute(mps->template get_position<long>(), dsetName, "position");
            ...
            if(mps->isCenter()) {
                h5file.writeAttribute(Eigen::Tensor<RealScalar<Scalar>, 1>(mps->get_LC().real()), dsetName, "LC");
                h5file.writeAttribute(mps->get_truncation_error_LC(), dsetName, "truncation_error_LC");
            }
        }
        h5file.writeAttribute(state.template get_length<size_t>(), mps_prefix, "model_size");
        h5file.writeAttribute(state.template get_position<long>(), mps_prefix, "position");
    ...
    template void save::state(h5pp::File &h5file, const StorageInfo &sinfo, const StateFinite<cx64> &state);
    template void save::state(h5pp::File &h5file, const StorageInfo &sinfo, const StateFinite<cx128> &state);

    /*! Write down the Hamiltonian model type and site info as attributes */
    template<typename Scalar>
    void save::model(h5pp::File &h5file, const StorageInfo &sinfo, const ModelFinite<Scalar> &model) {
    ...
    template void tools::finite::h5::save::model(h5pp::File &h5file, const StorageInfo &sinfo, const ModelFinite<cx64> &model);
    template void tools::finite::h5::save::model(h5pp::File &h5file, const StorageInfo &sinfo, const ModelFinite<cx128> &model);

    /*! Write all the MPO's with site info in attributes */
    template<typename Scalar>
    void tools::finite::h5::save::mpo(h5pp::File &h5file, const StorageInfo &sinfo, const ModelFinite<Scalar> &model) {
    ...
    template void tools::finite::h5::save::mpo(h5pp::File &h5file, const StorageInfo &sinfo, const ModelFinite<cx64> &model);
    template void tools::finite::h5::save::mpo(h5pp::File &h5file, const StorageInfo &sinfo, const ModelFinite<cx128> &model);
    ...
    template void save::data(h5pp::File &h5file, const StorageInfo &sinfo, const Eigen::Tensor<cx64, 1> &data, std::string_view data_name,
                             CopyPolicy copy_policy);
    template<typename Scalar>
    void save::simulation(h5pp::File &h5file, const TensorsFinite<Scalar> &tensors, const AlgorithmStatus &status, CopyPolicy copy_policy) {
        save::simulation(h5file, *tensors.state, *tensors.model, *tensors.edges, status, copy_policy);
    }
    template void save::simulation(h5pp::File &h5file, const TensorsFinite<cx64> &tensors, const AlgorithmStatus &status, CopyPolicy copy_policy);
    template void save::simulation(h5pp::File &h5file, const TensorsFinite<cx128> &tensors, const AlgorithmStatus &status, CopyPolicy copy_policy);

    template<typename Scalar>
    void save::simulation(h5pp::File &h5file, const StateFinite<Scalar> &state, const ModelFinite<Scalar> &model, const EdgesFinite<Scalar> &edges,
                          const AlgorithmStatus &status, CopyPolicy copy_policy) {
    ...
    template void save::simulation(h5pp::File &h5file, const StateFinite<cx64> &state, const ModelFinite<cx64> &model, const EdgesFinite<cx64> &edges,
                                   const AlgorithmStatus &status, CopyPolicy copy_policy);
    template void save::simulation(h5pp::File &h5file, const StateFinite<cx128> &state, const ModelFinite<cx128> &model, const EdgesFinite<cx128> &edges,
                                   const AlgorithmStatus &status, CopyPolicy copy_policy);
}