...
template<typename T>
void tools::finite::bex::internal::merge_mixing_terms_MP_N0(const StateFinite<T>      &state, //
                                                            MpsSite<T>                &mpsL,  //
...
template<typename T>
void tools::finite::bex::internal::merge_mixing_terms_N0_MP(const StateFinite<T>      &state, //
                                                            MpsSite<T>                &mpsL,  //
                                                            const Eigen::Tensor<T, 3> &N0,    //
                                                            MpsSite<T>                &mpsR,  //
                                                            const Eigen::Tensor<T, 3> &MP,    //
...
template<typename T>
std::pair<Eigen::Tensor<T, 3>, Eigen::Tensor<T, 3>> tools::finite::bex::internal::get_mixing_terms_MP_N0(const Eigen::Tensor<T, 3> &M,  //
...
template<typename T>
std::pair<Eigen::Tensor<T, 3>, Eigen::Tensor<T, 3>> tools::finite::bex::internal::get_mixing_terms_N0_MP(const Eigen::Tensor<T, 3> &N,  // Gets padded
