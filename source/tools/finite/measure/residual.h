...
namespace tools::finite::measure {
    ...
    template<typename Scalar>
    [[nodiscard]] RealScalar<Scalar> residual_norm       (const Eigen::Tensor<Scalar, 3> &mps, const std::vector<std::reference_wrapper<const MpoSite<Scalar>>> &mpo_refs, const env_pair<const EnvVar<Scalar> &> &envs);

    template<typename Scalar>
    [[nodiscard]] RealScalar<Scalar> residual_norm_H1    (const std::vector<size_t> & sites, const StateFinite<Scalar> &state, const ModelFinite<Scalar> &model, const EdgesFinite<Scalar> & edges);

    template<typename Scalar>
    [[nodiscard]] RealScalar<Scalar> residual_norm_H1    (const std::vector<size_t> & sites, const TensorsFinite<Scalar> & tensors);
    ...
    template<typename Scalar>
    [[nodiscard]] RealScalar<Scalar> residual_norm_H2    (const std::vector<size_t> & sites, const TensorsFinite<Scalar> & tensors);
    ...
    template<typename Scalar>
    [[nodiscard]] RealScalar<Scalar> residual_norm_full  (const TensorsFinite<Scalar> & tensors);
