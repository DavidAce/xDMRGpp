...
template TN<Scalar, 2> contract_chain_M_Mconj_0_2_01_20(const TN<Scalar, 2> &chain, const TN<Scalar, 3> &M, const ThreadPtr &threads);

template void contract_M_Ledge3_mpo_Mconj_1_1_12_03_01_30(TN<Scalar, 3> &temp, const TN<Scalar, 3> &M, const TN<Scalar, 3> &Ledge3, const TN<Scalar, 4> &mpo, const ThreadPtr &threads);
...
template TN<Scalar, 0> contract_envL_envR_012_012(const TN<Scalar, 3> &envL, const TN<Scalar, 3> &envR, const ThreadPtr &threads);
/* clang-format on */
