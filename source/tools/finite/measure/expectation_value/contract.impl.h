...
void tools::finite::measure::contract_internal<Scalar>::contract_op_M_1_0(TN<Scalar, 3> &temp, const TN<Scalar, 2> &op, const TN<Scalar, 3> &M,
...
// }
template<typename Scalar>
TN<Scalar, 2> tools::finite::measure::contract_internal<Scalar>::contract_chain_M_Mconj_0_1_01_10(const TN<Scalar, 2> &chain, const TN<Scalar, 3> &M,
                                                                                                  const ThreadPtr &threads) {
    if(chain.dimension(0) != M.dimension(1) or chain.dimension(1) != M.dimension(1))
        throw except::logic_error("contract_chain_M_Mconj_0_1_01_10: chain dims ({},{}) incompatible with M dims ({},{},{})", chain.dimension(0),
                                  chain.dimension(1), M.dimension(0), M.dimension(1), M.dimension(2));
...
template<typename Scalar>
TN<Scalar, 2> tools::finite::measure::contract_internal<Scalar>::contract_chain_M_Mconj_0_2_01_20(const TN<Scalar, 2> &chain, const TN<Scalar, 3> &M,
                                                                                                  const ThreadPtr &threads) {
    if(chain.dimension(0) != M.dimension(2) or chain.dimension(1) != M.dimension(2))
        throw except::logic_error("contract_chain_M_Mconj_0_2_01_20: chain dims ({},{}) incompatible with M dims ({},{},{})", chain.dimension(0),
                                  chain.dimension(1), M.dimension(0), M.dimension(1), M.dimension(2));
...
template<typename Scalar>
void tools::finite::measure::contract_internal<Scalar>::contract_M_Ledge3_mpo_Mconj_1_1_12_03_01_30(TN<Scalar, 3> &temp, const TN<Scalar, 3> &M,
                                                                                                    const TN<Scalar, 3> &Ledge3, const TN<Scalar, 4> &mpo,
                                                                                                    const ThreadPtr &threads) {
    temp.resize(M.dimension(2), M.dimension(2), mpo.dimension(1));
...
template<typename Scalar>
TN<Scalar, 0> tools::finite::measure::contract_internal<Scalar>::contract_Ledge3_Redge3_012_012(const TN<Scalar, 3> &Ledge3, const TN<Scalar, 3> &Redge3,
                                                                                                const ThreadPtr &threads) {
    TN<Scalar, 0> res;
...
template<typename Scalar>
void tools::finite::measure::contract_internal<Scalar>::contract_mps1_mpo_mps2_0_2_4_0(TN<Scalar, 4> &result, const TN<Scalar, 3> &bra,
                                                                                       const TN<Scalar, 4> &mpo, const TN<Scalar, 3> &ket,
                                                                                       const ThreadPtr &threads) {
    ...
    if(bd != wdo or kd != wdi)
        throw except::logic_error("contract_mps1_mpo_mps2_0_2_4_0: bra ({},{},{}) ket ({},{},{}) mpo ({},{},{},{})", bd, bL, bR, kd, kL, kR, wL, wR,
                                  wdi, wdo);
...
template<typename Scalar>
void tools::finite::measure::contract_internal<Scalar>::contract_res_mps1conj_mpo_mps2_1_1_13_02_14_10(TN<Scalar, 4> &tmp, const TN<Scalar, 4> &result,
                                                                                                       const TN<Scalar, 3> &bra, const TN<Scalar, 4> &mpo,
                                                                                                       const TN<Scalar, 3> &ket, const ThreadPtr &threads) {
    [[maybe_unused]] const long bd = bra.dimension(0);
    [[maybe_unused]] const long bL = bra.dimension(1);
    [[maybe_unused]] const long bR = bra.dimension(2);
    ...
    if(r1 != bL or r2 != wL or bd != wdo or kd != wdi)
        throw except::logic_error("contract_res_mps1conj_mpo_mps2_1_1_13_02_14_10: result ({},{},{},{}) bra ({},{},{}) mpo ({},{},{},{}) ket ({},{},{})",
                                  r0, r1, r2, r3, bd, bL, bR, wL, wR, wdi, wdo, kd, kL, kR);
...
template<typename Scalar>
void tools::finite::measure::contract_internal<Scalar>::contract_resL_ket_mpo_braconj_0_1_02_02_03_10(TN<Scalar, 3> &tmp, const TN<Scalar, 3> &resL,
                                                                                                      const TN<Scalar, 3> &ket, const TN<Scalar, 4> &mpo,
                                                                                                      const TN<Scalar, 3> &bra, const ThreadPtr &threads) {
    if(resL.dimension(0) != ket.dimension(1) or resL.dimension(1) != mpo.dimension(0) or ket.dimension(0) != mpo.dimension(2) or
       resL.dimension(2) != bra.dimension(1) or mpo.dimension(3) != bra.dimension(0))
        throw except::logic_error("contract_resL_ket_mpo_braconj_0_1_02_02_03_10: resL ({},{},{}) ket ({},{},{}) mpo ({},{},{},{}) bra ({},{},{})",
                                  resL.dimension(0), resL.dimension(1), resL.dimension(2), ket.dimension(0), ket.dimension(1), ket.dimension(2),
                                  mpo.dimension(0), mpo.dimension(1), mpo.dimension(2), mpo.dimension(3), bra.dimension(0), bra.dimension(1),
                                  bra.dimension(2));
...
template<typename Scalar>
TN<Scalar, 0> tools::finite::measure::contract_internal<Scalar>::contract_resL_envR_012_021(const TN<Scalar, 3> &resL, const TN<Scalar, 3> &envR,
                                                                                            const ThreadPtr &threads) {
    TN<Scalar, 0> res;
...
template<typename Scalar>
TN<Scalar, 0> tools::finite::measure::contract_internal<Scalar>::contract_envL_envR_012_012(const TN<Scalar, 3> &envL, const TN<Scalar, 3> &envR,
                                                                                            const ThreadPtr &threads) {
    TN<Scalar, 0> res;
