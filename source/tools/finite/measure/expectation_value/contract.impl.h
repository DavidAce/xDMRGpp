...
template<typename Scalar>
TN<Scalar, 0> tools::finite::measure::contract_internal<Scalar>::contract_Ledge3_Redge3_012_012(const TN<Scalar, 3> &Ledge3,
                                                                                                  const TN<Scalar, 3> &Redge3,
                                                                                                  const ThreadPtr &threads) {
    TN<Scalar, 0> res;
...
template<typename Scalar>
void tools::finite::measure::contract_internal<Scalar>::contract_res_mps1conj_mpo_mps2_1_1_13_02_14_10(TN<Scalar, 4> &tmp,
                                                                                                         const TN<Scalar, 4> &result,
...
template<typename Scalar>
void tools::finite::measure::contract_internal<Scalar>::contract_resL_ket_mpo_braconj_0_1_02_02_03_10(TN<Scalar, 3> &tmp,
