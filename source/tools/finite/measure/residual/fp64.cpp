...
/* clang-format off */
template RealScalar<Scalar> tools::finite::measure::residual_norm(const Eigen::Tensor<Scalar, 3> &mps, const Eigen::Tensor<Scalar, 4> &mpo, const x2::Tensor<Scalar, 3> &envL, const x2::Tensor<Scalar, 3> &envR);

template RealScalar<Scalar> tools::finite::measure::residual_norm(const Eigen::Tensor<Scalar, 3> &mps, const std::vector<Eigen::Tensor<Scalar, 4>> &mpos, const x2::Tensor<Scalar, 3> &envL, const x2::Tensor<Scalar, 3> &envR);
